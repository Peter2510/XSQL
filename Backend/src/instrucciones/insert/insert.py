...
class insertInstruccion(Abstract):
    ...
    def interpretar(self,environment):
        ...
        if (Estructura.nombreActual != None and Estructura.nombreActual != ''):
            yaSellamoDB = True
        print(yaSellamoDB, Estructura.nombreActual)
        if (yaSellamoDB==True):
    ...
    #                            cantidadValidaElementos+=1
            ...
            environment.addError("Semantico", "" ,f"no hay base de datos a usar", self.fila,self.columna)
